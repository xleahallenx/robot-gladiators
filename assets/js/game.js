...
// generate random enemy.health value based on player's attack power
    enemy.health = Math.max(0, enemy.health - enemy.health);
    console.log(
   ...
   playerHealth = Math.max(0, playerInfo.health - damamge);
    console.log(
